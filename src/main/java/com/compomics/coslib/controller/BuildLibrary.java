...
public class BuildLibrary {
     ...
     *
     * @param d data containing the information
     */
    ...
    public void Start() {
        ...
        while (iter.hasNext()) {  //endless loop, ternimates startIndex>=lengthSpectra  
            ...
            //cluster same spectra: same sequence, MW, charge, modification
        ...
        for (Map.Entry<String, ArrayList<Spectrum>> cs : clusteredSpectra.entrySet()) {
            ...
            for (Map.Entry<Integer, ArrayList<Spectrum>> mp : samePeakSize.entrySet()) {
                ...
                while (len3 > 0) {
                    ...
                    //calculate peaks intensity(average) and update one of the same spec's intensity and write to the library
                    AveragingSpecs(sameSpecs);
     ...
     * library
     */
    private void AveragingSpecs(ArrayList<Spectrum> samespecs) {
        ...
        write2library(representative_spec);
